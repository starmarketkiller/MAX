...
- **In attesa**: risultato del test 3 mesi + 3 anni su MT5. Il 3 anni è il test che
  conta — deve smettere di azzerare il conto (v2.4.8 aveva fatto DD 87% fuori-campione).
- Uniche strategie confermate robuste su *entrambi* gli orizzonti finora: **TURTLE_SOUP**,
  **BJORGUM**, **MACD**.
