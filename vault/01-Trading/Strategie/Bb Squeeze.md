...
## Trigger meccanico
Squeeze di volatilità (banda strettissima) + breakout. Disabilitata: campione troppo piccolo su MT5.
...
## Stato
🔴 DISABILITATA — POCHI_DATI — campione troppo piccolo per giudicare.
