...
| ⚠️ | **Backtest 10 anni segmentato (10/10 arrivati al 15/07 — completo)** | Segmenti 1-3 falliti per bug di esecuzione del tester + race condition della pipeline che duplicava report vecchi (stesso bug riapparso sul segmento 10, fixato in corsa — vedi [[NEXUS EA - Backtest 10Y Segmentato (v2.5.0)]] per il dettaglio del bug pipeline). **Segmenti 4-9 (6 anni reali, 2019-2024): tutti e 6 in perdita** (PF 0.63-0.98, DD fino a 88.69% nel 2024 — il peggiore, con qualità storico 100%). SAR/MACD/RSI_DIV/ADX_RSI sono ~75% della perdita totale (-88.2R su -118.1R). Il segmento 9 ha ridimensionato TURTLE_SOUP (da +7.3R a +0.1R su 6 anni) e peggiorato RSI_DIV (ora tra le fallite). Nucleo hedge TURTLE_SOUP+BREAKOUT_ACC+CISD: +7.6R su 6 anni (era +14.7R su 5). **Segmento 10 (2025-26) ancora da integrare nell'analisi R-per-strategia** — per ora si sa solo il conteggio trade totali (1559, il più alto di tutti). Vedi [[NEXUS EA - Backtest 10Y Segmentato - Analisi]] e [[NEXUS EA - Hedge nel Tempo]] per l'analisi economica, [[NEXUS EA - Backtest 10Y Segmentato (v2.5.0)]] per il bug di pipeline e l'anomalia 2016-2019 (17/3/59 trade contro 500-1500+ degli anni successivi, causa non confermata). |
...
## Collegamenti
[[MOC - Trading]] · [[NEXUS EA - Lezione Overfitting 3Y]] · [[NEXUS EA - Screening Strategie (sito 10y)]] · [[NEXUS EA - Backtest 10Y Segmentato - Analisi]] · [[NEXUS EA - Hedge nel Tempo]] · [[NEXUS EA - Backtest 10Y Segmentato (v2.5.0)]]
