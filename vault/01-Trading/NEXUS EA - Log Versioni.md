...
| ⚠️ | **Backtest 10 anni segmentato (10 segmenti da 1Y, arrivati 9/10 al 15/07)** | Segmenti 1-3 falliti per bug di esecuzione del tester (ri-eseguire). **Segmenti 4-9 (6 anni reali, 2019-2024): tutti e 6 in perdita** (PF 0.63-0.98, DD fino a 88.69% nel 2024 — il peggiore, con qualità storico 100%). SAR/MACD/RSI_DIV/ADX_RSI sono ~75% della perdita totale (-88.2R su -118.1R). Il segmento 9 ha ridimensionato TURTLE_SOUP (da +7.3R a +0.1R su 6 anni) e peggiorato RSI_DIV (ora tra le fallite). Nucleo hedge TURTLE_SOUP+BREAKOUT_ACC+CISD: +7.6R su 6 anni (era +14.7R su 5). Vedi [[NEXUS EA - Backtest 10Y Segmentato - Analisi]] e [[NEXUS EA - Hedge nel Tempo]]. |
