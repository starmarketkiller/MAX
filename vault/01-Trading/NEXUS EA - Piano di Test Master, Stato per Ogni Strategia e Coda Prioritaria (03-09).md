...
|---|---|---|---|
| SAR | ⚠️ **IN RIVALIDAZIONE (08/09) — NON usare per decisioni di portfolio** | Il PF1.37-1.57/5 finestre citato qui girava col bug `InpRiskProfile` (BALANCED forzava un DD-cap 5%/giorno mai richiesto, `InpMaxDailyDDPct=100.0` nell'.ini). Re-run con fix vero su 1 delle 5 finestre: PF 2.02→**1.90**, DD equity 45.47%→**53.67%**. Le altre 4 finestre in corso di re-run (08/09) | [[NEXUS EA - SAR Confermata Positiva Invalidata, il Bug Nascondeva un Freno di Sicurezza (08-09)]] · [[NEXUS EA - Sintesi Sessione Maratona SAR-EMA_PULLBACK-Scalp-RegimeVeto (01-02-09)]] (superata) |
