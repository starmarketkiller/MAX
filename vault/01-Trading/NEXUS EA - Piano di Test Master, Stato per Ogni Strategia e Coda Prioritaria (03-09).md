...
| 2 | ADX_RSI | 2.62 (2.57/2.66) | trailing+Elliott, BUY-only | ✅ **Confermata sul vero MT5 (04/09)**: nudo PF2.04, net+$1676/3anni, BUY domina (conferma diretta). Vedi [[NEXUS EA - ADX_RSI D1 Confermata Positiva sul Vero MT5, BUY Domina (04-09)]]. **Elliott testato (06/09): peggiora** (PF2.04→1.65, net+$1676→+$1234) — restare sulla ricetta nuda, vedi [[NEXUS EA - ADX_RSI Filtro Elliott Peggiora, Restare sulla Ricetta Nuda (06-09)]]. Trailing 2.5×ATR richiede modifica al profilo hardcoded, non ancora testato |
...
| 13 | MACD | 1.84 (1.53/2.17) | trailing+Elliott | ✅ **Confermata sul vero MT5 (04/09)**: nudo H4 PF1.53, net+$1975/3anni. BUY domina (129 trade, WR37.2%, +$2273) SELL rumore (70 trade, +$162). Vedi [[NEXUS EA - MACD H4 Confermata Positiva, Terza Conferma BUY-Dominante (04-09)]]. Time-stop 80 barre (06/09): neutro in aggregato, SELL diventa negativo (-$54) — vedi [[NEXUS EA - MACD 80 Barre vs 40, Neutro in Aggregato Peggiora su SELL (06-09)]]. **Elliott (06/09): neutro** (PF1.53→1.51, net+$1975→+$1900, -2 trade) — a differenza di ADX_RSI/BOLLINGER dove peggiora chiaramente. Verificata anche l'ipotesi "ritracciamento prima di entrare" (idea utente): MAE vincenti 81pip vs perdenti 295pip, stesso pattern controintuitivo di ADX_RSI — il filtro ingenuo scarterebbe più vincenti che perdenti evitati. Vedi [[NEXUS EA - MACD Elliott Neutro, e il Ritracciamento Conferma il Pattern Controintuitivo (06-09)]] |
...
|---|---|---|---|
| SAR | ✅ Confermata — **verificata immune al bug RiskProfile (08/09)** | Lotto naturale, candle-align H4, PF1.37-1.57 su 4 finestre (step22-25) — re-run con `InpRiskProfile=0` vero: **identico byte-per-byte** su tutte e 4 (nessun rientro PipSeq, il DD-cap forzato non ha mai avuto occasione di bloccare nulla). ⚠️ La variante separata con PipSeq (`step35_badwindow_clean_veto`, test di stress, non la config confermata) **resta invalidata**: PF2.02→1.90, DD equity 45.47%→53.67% | [[NEXUS EA - SAR Verdetto Definitivo, Confermata Sopravvive PipSeq No (08-09)]] · [[NEXUS EA - Sintesi Sessione Maratona SAR-EMA_PULLBACK-Scalp-RegimeVeto (01-02-09)]] |
| EMA_PULLBACK | ✅ Confermata robusta — verificata immune al bug RiskProfile (08/09) | Nuda; **walk-forward 4 finestre (04/09) tutte positive, PF1.44→1.71 in miglioramento**. ⚠️ le "4 finestre" condividono lo stesso `ToDate` (periodi annidati, non indipendenti — stesso giorno peggiore in tutte e 4); il trend di miglioramento è reale ma meno probante di "4 prove indipendenti" | [[NEXUS EA - EMA_PULLBACK Walk-Forward 4 Finestre, Tutte Positive (04-09)]] · [[NEXUS EA - Controllo CSV SAR-EMA_PULLBACK, EMA_PULLBACK Pulita SAR da Riverificare (08-09)]] |
...
| ADX_RSI | ✅ Confermata | D1 nudo (config attuale), PF2.04, BUY domina. Elliott testato: peggiora (PF→1.65) — restare nuda | [[NEXUS EA - ADX_RSI D1 Confermata Positiva sul Vero MT5, BUY Domina (04-09)]] · [[NEXUS EA - ADX_RSI Filtro Elliott Peggiora, Restare sulla Ricetta Nuda (06-09)]] |
