...
EVENTS_PATH = os.path.join(DATA_DIR, "events_holdout.csv")
OUT_PATH = os.path.join(DATA_DIR, "outcomes_holdout.csv")
META_PATH = os.path.join(DATA_DIR, "outcomes_holdout.meta.json")
